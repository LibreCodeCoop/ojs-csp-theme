		...
		<header class="navbar navbar-default" id="headerNavigationContainer" role="banner" {if !$loginUrl} style="background-image: url({$issue->getLocalizedCoverImageUrl()|escape}" alt="{$issue->getLocalizedCoverImageAltText()|escape|default:''})" {/if}>
			...
			<div class="container-fluid" id="logo-csp">
				<div class="row">
					...
					<div class="col-md-2" id="social-icons">
						...
						<ul class="dropdown-menu">
							<li>
								<a data-original-title="Twitter" rel="tooltip"  href="https://twitter.com/intent/tweet?url={$baseUrl}{$requestPath}" class="btn btn-twitter" data-placement="left">
							...
							<li>
								<a data-original-title="Facebook" rel="tooltip"  href="https://www.facebook.com/sharer/sharer.php?u={$baseUrl}{$requestPath}" class="btn btn-facebook" data-placement="left">
							...
							<li>
								<a data-original-title="LinkedIn" rel="tooltip"  href="http://www.linkedin.com/shareArticle?url={$baseUrl}{$requestPath}" class="btn btn-linkedin" data-placement="left">
