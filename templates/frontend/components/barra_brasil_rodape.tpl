<div id="foote-barra-brasil" class="row">
    <div class="col-md-2">
        <a target="_blank" href="https://portal.fiocruz.br/acesso-informacao">
            <img src="{$baseUrl}/plugins/themes/csp/assets/barra-brasil/footer/acesso.png">
    ...
    <div class="col-md-1">
        <a target="_blank" href="https://agencia.fiocruz.br/100-anos-do-castelo-fiocruz">
            <img src="{$baseUrl}/plugins/themes/csp/assets/barra-brasil/footer/120anos.png">
    ...
    <div class="col-md-2">
        <a target="_blank" href="http://portalms.saude.gov.br/sistema-unico-de-saude/sistema-unico-de-saude">
            <img src="{$baseUrl}/plugins/themes/csp/assets/barra-brasil/footer/sus.png">
